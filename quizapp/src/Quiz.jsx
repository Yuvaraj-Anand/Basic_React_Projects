  ...
  return (
    <div className='quiz'>
      ...
      <ul>
        ...
        onClick={()=>{handeleSelect('Option1')}}>{data[index].Option1}</li>

        <li className={option === 'Option2'? 'selected':'' }
        onClick={()=>{handeleSelect('Option2')}}>{data[index].Option2}</li>
        
        <li className={option === 'Option3'? 'selected':'' }
        onClick={()=>{handeleSelect('Option3')}}>{data[index].Option3}</li>
        
        <li className={option === 'Option4'? 'selected':'' }
        onClick={()=>{handeleSelect('Option4')}}>{data[index].Option4}</li>
      </ul>
      <button onClick={handeleNext} disabled= {!option}>Next</button>
